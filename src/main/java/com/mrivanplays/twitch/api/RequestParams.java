...
/**
 * Took from <a href="https://github.com/urgrue/java-async-http/blob/master/src/main/java/com/mb3364/http/RequestParams.java">java-async-http</a>
 *
 * @author urgrue
 */
public class RequestParams {
    ...
    private Map<String, File> fileParams = new ConcurrentHashMap<>();
